...
public class SearchWrapper implements Constants {
    ...
    public JsonNode executeStringQuery(ExecutionContext context, JsonNode requestData) throws Exception {
        ...
        if (resource != null) {
                    ...
                    log.debug("Executing search query [{}] on tenant [{}] using resource [{}]", query, context.getTenant(),
                    ...
                    log.debug("Executing search query [{}] on tenant [{}] with no specified resource", query,
